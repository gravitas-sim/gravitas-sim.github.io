...
//
// Where it runs: the catalog (/catalog/, CATALOG.md) installs a curated
// course for offline use and shows its units, notes and a link into each
// lesson; the course-pack builder (roadmap Prompt 31) will author them. The
// SDK validates, tests and archives one (sdk/lib/course.mjs re-exports this),
// and the catalog page validates what it installs with the same function.
// Pure, with no imports, so the page and the tools share it.
// =============================================================================
