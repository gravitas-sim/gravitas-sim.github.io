...
export const PROVIDES = {
  ...
  translations: 'locale',
  dataPacks: 'id',
  // A sequence of existing lessons (gravitas.course-pack/1, ./course.js).
  // Declarative: the SDK validates and archives it, and the catalog installs
  // a curated one and shows its units (CATALOG.md).
  courses: 'id',
};
