...
export default {
  ...
  steps: [
    ...
    {
      title: 'Lo que has establecido',
      body: '<strong>Una onda gravitacional es un cambio de distancia, no algo que llega.</strong> No te cae nada encima. La separación entre cosas que no se tocan se hace brevemente mayor en una dirección y menor en la perpendicular, y ya está.\n\n<strong>Una fuente tiene que estar cambiando, y tiene que ser asimétrica.</strong> Una masa quieta no radia nada. Una masa que late hacia dentro y hacia fuera tampoco radia nada, por violentamente que lo haga, porque se ve igual desde cualquier dirección. Dos objetos girando uno alrededor del otro no están quietos ni son simétricos, y por eso el binario fue el que funcionó y los otros dos no.\n\n<strong>El estiramiento y la compresión son transversales.</strong> Los dos son perpendiculares al sentido en que viaja la onda, y por eso un anillo de masas de prueba se vuelve un óvalo y no un círculo más grande. No ha crecido nada.\n\n<strong>Una órbita que se encoge produce una señal que sube</strong>, al doble de la frecuencia orbital: más cerca y más rápido significa más agudo y más fuerte, y eso es lo que hace que el patrón de la pantalla 1 sea un chirrido y no un zumbido.\n\n<strong>Un instrumento en forma de L mide una diferencia.</strong> Dos brazos perpendiculares responden de forma opuesta a la misma onda, así que comparar uno con otro convierte un cambio de longitud mucho menor que un protón en algo que se puede registrar.',
