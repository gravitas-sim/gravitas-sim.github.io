...
export const ES_DEFERRED = {
  ...
  'binW.capture': 'Capturar esta órbita',
  ...
  'inv.tag.stellar-evolution': 'Evolución estelar',
  'inv.tag.waves': 'Ondas gravitacionales',
  ...
  'inv.seq.waves.title': 'Ondas gravitacionales, desde cero',
  'inv.seq.waves.blurb':
    'Qué es de verdad lo que llega, y luego qué puede y qué no puede decirte una sola señal sobre la fuente que la emitió.',
  'inv.seq.waves.what-is-a-gravitational-wave':
    'No supone física previa y no hay nada que leer antes. Qué tiene que estar moviéndose, qué viaja, qué se estira y cómo lo nota un instrumento.',
  'inv.seq.waves.listening-to-spacetime':
    'El mismo instrumento llevado mucho más lejos: medir una fuente a partir de su señal, y comparar un modelo con lo que dos detectores registraron de verdad. Mucho más fácil si has hecho la primera, pero no depende de ella.',
  ...
  'gwW.row.strainAmplitude': 'Amplitud de la deformación',
  'gwW.value.strainNow':
    '{strain}: dónde está la onda dentro de esa oscilación en este instante, que pasa por cero dos veces por ciclo. La amplitud de arriba es el número que hay que anotar como pico.',
  ...
  'gwW.row.loudness': 'Qué tan fuerte suena',
  'gwW.value.loudness.fixed':
    'Escalado con una referencia fija que no se mueve al cambiar un control, así que el volumen sigue a la deformación: esta señal es el {percent} de esa referencia. Es una razón de amplitudes y no de volumen percibido: reducir la amplitud a la mitad no reduce a la mitad lo fuerte que suena.',
  'gwW.value.loudness.peak':
    'Llevado a escala completa, así que todas las señales suenan igual de fuertes sea cual sea su deformación. Sirve para oír la forma de una onda y no sirve para comparar dos: para eso está el modo de referencia fija.',
  'gwW.row.clipped': 'Recortado',
  'gwW.value.clipped':
    '{n} muestras llegaron a la escala completa y se limitaron. La referencia es fija para poder comparar distancias, y los ajustes más cercanos son más fuertes que ella: la forma es correcta y los picos quedan aplanados.',
  ...
  'bhW.captureTrials': 'Capturar estos ensayos',
  ...
  'nb.gw.audioReference': 'Deformación de referencia del audio',
  'nb.gw.audioReferenceNote':
    'la deformación que corresponde a la escala completa; fija para toda la comparación e independiente de los controles',
  'nb.gw.audioFraction': 'Esta señal, como fracción de ella',
  'nb.gw.audioFractionNote':
    'una razón de amplitudes, no una razón de volumen percibido',
  'nb.gw.limit.audioFixed':
    'El sonido se escaló con una referencia fija que no se mueve al mover un control, así que el volumen relativo sigue a la deformación relativa. Es una relación de amplitudes; no es cuánto más fuerte suena algo.',
  'nb.gw.limit.audioPeak':
    'El sonido se llevó a escala completa, así que su volumen no dice nada sobre la deformación. Dos lecturas tomadas así no se pueden comparar de oído.',
  'nb.gw.limit.audioClipped':
    '{n} muestras de audio llegaron a la escala completa y se limitaron, de modo que los picos quedaron aplanados. La deformación dibujada no se ve afectada.',
  'nb.gw.limit.model':
  ...
  'welcomeAudience.instructors.text':
    '24 investigaciones guiadas para astronomía introductoria y de formación general, con guías docentes, soluciones y enlaces de simulación que se pueden compartir.',
  ...
  'stelW.lab.row.boundStar': 'Estrella en la escena',
  'stelW.lab.note':
  ...
  // --- Una órbita binaria medida en la escena principal ----------------------
  'nb.source.horizon-trials': 'Ensayos de horizonte',
  'nb.horizon.title': 'Cómo crece el horizonte de sucesos con la masa',
  'nb.horizon.trial': 'Ensayo {n}, a {mass} M☉',
  'nb.horizon.ratio': 'Razón de radios ÷ razón de masas',
  'nb.horizon.ratioNote':
    'Uno significa que el radio es directamente proporcional a la masa, que es lo que dice 2GM/c² que debe ser.',
  'nb.horizon.evidence':
    'Se eligieron {n} masas y se calculó el radio de Schwarzschild para cada una. Lo que se diseñó aquí es la campaña —qué masas, y cómo se espacian—, no los números, que se siguen solo de la masa.',
  'nb.horizon.limit.analytic':
    'Aquí no se midió nada. Cada radio es 2GM/c² evaluado para una masa elegida.',
  'nb.horizon.limit.drawn':
    'El agujero negro dibujado en el lienzo está a una escala de visualización elegida para que sus órbitas quepan en una ventana. Su tamaño dibujado no es una longitud.',
  'nb.horizon.limit.nonrotating':
    'Se supone un agujero negro sin rotación y sin carga. Los agujeros negros reales suelen rotar, lo que cambia la forma del horizonte.',
  'nb.binary.title': 'Órbita binaria, medida en la escena',
  'nb.binary.separation': 'Separación, de estrella a estrella',
  'nb.binary.arm': 'De {star} al punto de equilibrio',
  'nb.binary.period': 'Periodo orbital',
  'nb.binary.total': 'Masa total del par',
  ...
  'nb.binary.evidence':
    'Ambas estrellas giran en torno a su punto de equilibrio común. La separación y la distancia de cada estrella a ese punto se leyeron en la escena principal; la masa total se deduce de la separación y el periodo.',
  'nb.binary.limit.circular':
    'El par se dispuso en órbitas circulares. Una binaria real es excéntrica, y su separación cambia a lo largo de la órbita.',
  'nb.binary.limit.faceOn':
    'La órbita se ve de frente. Una órbita real está inclinada, y la separación que mide un observador es una proyección de la verdadera.',
  'nb.binary.limit.untimed':
    'El periodo de aquí vino del modelo, no de un cronómetro, así que esta entrada registra una predicción en vez de una medición.',
  ...
  'specW.row.cite': 'Fuente',
  'specW.row.measured': 'Cómo se mide el número de {feature}',
  'specW.value.region':
    'medida en {line} Å, frente a la media de {blue} y {red} Å (en aire)',
  'specW.value.regionHead':
    'medida en {line} Å, frente a {ref} Å justo antes de la cabeza de banda (en aire)',
