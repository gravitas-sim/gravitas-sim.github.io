...
export const EN = {
  ...
  'footer.attribution.hint.2':
    'What the physics engine has been checked against: 281 checks with measured error, stated tolerance, and a reason for every tolerance. Runs live in your browser.',
  ...
  'rail.objectType.armedHint':
    '{type}: click or drag on the canvas to place one, or press Escape to cancel',
  ...
  'state.saved': 'Simulation state saved',
  'state.saveFailed': 'Could not save the simulation state',
  ...
  'objectName.star': 'Star',
  'objectName.planet': 'Rocky planet',
  'objectName.gasGiant': 'Gas giant',
  'objectName.asteroid': 'Asteroid',
  'objectName.comet': 'Comet',
  'objectName.whiteDwarf': 'White dwarf',
  'objectName.neutronStar': 'Neutron star',
  'objectName.blackHole': 'Black hole',
