...
export const ES = {
  ...
  'footer.attribution.hint.2':
    'Contra qué se ha comprobado el motor físico: 248 verificaciones con error medido, tolerancia declarada y una razón para cada tolerancia. Se ejecuta en directo en el navegador.',
