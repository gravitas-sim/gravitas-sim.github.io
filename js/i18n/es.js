...
export const ES = {
  ...
  'footer.attribution.hint.2':
    'Contra qué se ha comprobado el motor físico: 269 verificaciones con error medido, tolerancia declarada y una razón para cada tolerancia. Se ejecuta en directo en el navegador.',
  ...
  'rail.objectType.armedHint':
    '{type}: haz clic o arrastra en el lienzo para colocar uno, o pulsa Escape para cancelar',
  ...
  'settings.label.trailColorMode': 'Color de las trazas',
  ...
  'settings.option.trailColorMode.type': 'Por tipo',
  'settings.option.trailColorMode.speed': 'Por velocidad',
  ...
  'place.keyboard.canceled': 'Colocacion cancelada. No se anadio nada.',
  ...
  'state.saved': 'Estado de la simulación guardado',
  'state.saveFailed': 'No se pudo guardar el estado de la simulación',
  ...
  'easter.colorsRandomized': 'Colores aleatorios: mira el panel de ajustes',
  'placement.place': 'Haz clic o arrastra para colocar',
  'placement.cancel': 'Esc para cancelar',
  'placement.added': 'Objeto añadido: {type}',
  'objectName.star': 'Estrella',
  'objectName.planet': 'Planeta rocoso',
  'objectName.gasGiant': 'Gigante gaseoso',
  'objectName.asteroid': 'Asteroide',
  'objectName.comet': 'Cometa',
  'objectName.whiteDwarf': 'Enana blanca',
  'objectName.neutronStar': 'Estrella de neutrones',
  'objectName.blackHole': 'Agujero negro',
  ...
  'sound.button.label': 'Ajustes de sonido',
  'sound.button.hint': 'Ajustes de sonido',
  'sound.button.labeled': 'Ajustes de sonido: {state}',
  'sound.state.unsupported': 'audio no disponible',
  'sound.state.muted': 'apagado',
