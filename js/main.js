...
import { initialize_simulation, show_scenario_info, state, updateSpeedDisplay, updateObjectTypeButton } from './ui.js';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    canvas.addEventListener('touchend', (e) => {
        ...
        if (tapLength < 500 && tapLength > 0) {
            ...
            state.zoom = 1.5;  // Use the improved zoom level
    ...
    if ('ontouchstart' in window && window.innerWidth <= 768) {
        ...
        if (mobileInstructions && !localStorage.getItem('mobile_instructions_shown')) {
