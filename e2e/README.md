...
| `authorWalk.spec.js`       | All 12 investigations and all 370 steps: each setup applied, each widget painted, each probe reporting, required interactions performed, declared answers accepted, and every lesson reaching its report            |
