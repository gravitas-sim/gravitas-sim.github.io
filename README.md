...
```bash
npm test                  # <!--fact:jestTests-->3315<!--/fact--> tests across <!--fact:jestSuites-->85<!--/fact--> suites
...
The suite is <!--fact:e2eTests-->501<!--/fact--> tests
in <!--fact:e2eFiles-->43<!--/fact--> files and takes several minutes in
Chromium.
