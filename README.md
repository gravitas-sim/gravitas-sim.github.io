...
of <!--fact:uiStrings-->4077<!--/fact--> strings, and
...
```bash
npm test                  # <!--fact:jestTests-->5845<!--/fact--> tests across <!--fact:jestSuites-->170<!--/fact--> suites
...
| JavaScript on demand   | <!--fact:buildDeferredJs-->4174<!--/fact--> KB         | <!--fact:buildDeferredChunks-->156<!--/fact--> |
...
The suite is <!--fact:e2eTests-->1212<!--/fact--> tests
in <!--fact:e2eFiles-->91<!--/fact--> files and takes several minutes in
Chromium.
