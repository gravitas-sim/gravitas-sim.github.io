...
of <!--fact:uiStrings-->3611<!--/fact--> strings, and
...
```bash
npm test                  # <!--fact:jestTests-->5341<!--/fact--> tests across <!--fact:jestSuites-->150<!--/fact--> suites
...
| JavaScript on demand   | <!--fact:buildDeferredJs-->3891<!--/fact--> KB         | <!--fact:buildDeferredChunks-->142<!--/fact--> |
...
The suite is <!--fact:e2eTests-->1187<!--/fact--> tests
