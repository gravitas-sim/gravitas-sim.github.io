...
investigations**, <!--fact:investigationSteps-->683<!--/fact--> steps between
them:
...
of <!--fact:uiStrings-->4746<!--/fact--> strings, and
...
```bash
npm test                  # <!--fact:jestTests-->6238<!--/fact--> tests across <!--fact:jestSuites-->191<!--/fact--> suites
...
| JavaScript on demand   | <!--fact:buildDeferredJs-->4177<!--/fact--> KB         | <!--fact:buildDeferredChunks-->182<!--/fact--> |
...
The suite is <!--fact:e2eTests-->1320<!--/fact--> tests
in <!--fact:e2eFiles-->103<!--/fact--> files and takes several minutes in
Chromium.
