...
of <!--fact:uiStrings-->4318<!--/fact--> strings, and
...
```bash
npm test                  # <!--fact:jestTests-->6090<!--/fact--> tests across <!--fact:jestSuites-->185<!--/fact--> suites
...
The suite is <!--fact:e2eTests-->1280<!--/fact--> tests
in <!--fact:e2eFiles-->97<!--/fact--> files and takes several minutes in
Chromium.
