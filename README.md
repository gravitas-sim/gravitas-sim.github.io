...
investigations**, <!--fact:investigationSteps-->649<!--/fact--> steps between
them:
...
of <!--fact:physicsChecks-->281<!--/fact--> checks with measured error against a
...
of <!--fact:uiStrings-->3625<!--/fact--> strings, and
...
```bash
npm test                  # <!--fact:jestTests-->5417<!--/fact--> tests across <!--fact:jestSuites-->150<!--/fact--> suites
...
| JavaScript on demand   | <!--fact:buildDeferredJs-->3930<!--/fact--> KB         | <!--fact:buildDeferredChunks-->139<!--/fact--> |
...
That is <!--fact:physicsChecks-->281<!--/fact--> deterministic checks, about
