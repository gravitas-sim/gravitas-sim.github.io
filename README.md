...
of <!--fact:uiStrings-->3613<!--/fact--> strings, and
...
```bash
npm test                  # <!--fact:jestTests-->5449<!--/fact--> tests across <!--fact:jestSuites-->161<!--/fact--> suites
...
| JavaScript on demand   | <!--fact:buildDeferredJs-->3880<!--/fact--> KB         | <!--fact:buildDeferredChunks-->139<!--/fact--> |
...
The suite is <!--fact:e2eTests-->1186<!--/fact--> tests
