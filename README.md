...
**<!--fact:scenarios-->55<!--/fact--> built-in scenarios**, from the Solar
...
**<!--fact:investigations-->14<!--/fact--> guided
investigations**, <!--fact:investigationSteps-->415<!--/fact--> steps between
them:
...
the <!--fact:investigations-->14<!--/fact--> investigations — learning
...
of <!--fact:physicsChecks-->218<!--/fact--> checks with measured error against a
...
of <!--fact:uiStrings-->1945<!--/fact--> strings, and
all <!--fact:investigations-->14<!--/fact--> investigations are translated. A
...
That is <!--fact:physicsChecks-->218<!--/fact--> deterministic checks, about
...
all <!--fact:scenarios-->55<!--/fact--> shipped scenarios in a real browser, and
...
There are <!--fact:investigations-->14<!--/fact--> instructor
guides, <!--fact:investigations-->14<!--/fact--> answer keys, an adopter's guide
