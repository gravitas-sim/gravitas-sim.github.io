...
of <!--fact:uiStrings-->4516<!--/fact--> strings, and
...
```bash
npm test                  # <!--fact:jestTests-->6147<!--/fact--> tests across <!--fact:jestSuites-->188<!--/fact--> suites
...
The suite is <!--fact:e2eTests-->1293<!--/fact--> tests
in <!--fact:e2eFiles-->100<!--/fact--> files and takes several minutes in
Chromium.
