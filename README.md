...
investigations**, <!--fact:investigationSteps-->654<!--/fact--> steps between
them:
...
```bash
npm test                  # <!--fact:jestTests-->5351<!--/fact--> tests across <!--fact:jestSuites-->150<!--/fact--> suites
...
The suite is <!--fact:e2eTests-->1178<!--/fact--> tests
