...
of <!--fact:uiStrings-->4941<!--/fact--> strings, and
...
```bash
npm test                  # <!--fact:jestTests-->6266<!--/fact--> tests across <!--fact:jestSuites-->192<!--/fact--> suites
...
The suite is <!--fact:e2eTests-->1329<!--/fact--> tests
