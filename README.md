...
**<!--fact:investigations-->15<!--/fact--> guided
investigations**, <!--fact:investigationSteps-->441<!--/fact--> steps between
them:
...
the <!--fact:investigations-->15<!--/fact--> investigations — learning
...
```bash
npm test                  # <!--fact:jestTests-->2918<!--/fact--> tests across <!--fact:jestSuites-->74<!--/fact--> suites
...
| JavaScript on demand   | <!--fact:buildDeferredJs-->2462<!--/fact--> KB         | <!--fact:buildDeferredChunks-->76<!--/fact--> |
...
The suite is <!--fact:e2eTests-->409<!--/fact--> tests
in <!--fact:e2eFiles-->35<!--/fact--> files and takes several minutes in
Chromium.
...
There are <!--fact:investigations-->15<!--/fact--> instructor
guides, <!--fact:investigations-->15<!--/fact--> answer keys, an adopter's guide
