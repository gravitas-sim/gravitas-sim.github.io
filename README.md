...
**<!--fact:investigations-->21<!--/fact--> guided
investigations**, <!--fact:investigationSteps-->594<!--/fact--> steps between
them:
...
the <!--fact:investigations-->21<!--/fact--> investigations — learning
...
of <!--fact:uiStrings-->3398<!--/fact--> strings, and
all <!--fact:investigations-->21<!--/fact--> investigations are translated. A
...
There are <!--fact:investigations-->21<!--/fact--> instructor
guides, <!--fact:investigations-->21<!--/fact--> answer keys, an adopter's guide
