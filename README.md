...
of <!--fact:uiStrings-->4022<!--/fact--> strings, and
...
```bash
npm test                  # <!--fact:jestTests-->5769<!--/fact--> tests across <!--fact:jestSuites-->168<!--/fact--> suites
...
| JavaScript on demand   | <!--fact:buildDeferredJs-->4076<!--/fact--> KB         | <!--fact:buildDeferredChunks-->151<!--/fact--> |
...
The suite is <!--fact:e2eTests-->1208<!--/fact--> tests
in <!--fact:e2eFiles-->90<!--/fact--> files and takes several minutes in
Chromium.
