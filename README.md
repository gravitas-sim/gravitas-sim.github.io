...
of <!--fact:uiStrings-->2543<!--/fact--> strings, and
...
```bash
npm test                  # <!--fact:jestTests-->3321<!--/fact--> tests across <!--fact:jestSuites-->86<!--/fact--> suites
...
| JavaScript on demand   | <!--fact:buildDeferredJs-->2760<!--/fact--> KB         | <!--fact:buildDeferredChunks-->101<!--/fact--> |
| **Initial download**   | **<!--fact:buildInitialDownload-->823<!--/fact--> KB** |                                               |
...
The suite is <!--fact:e2eTests-->509<!--/fact--> tests
