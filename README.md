...
of <!--fact:physicsChecks-->248<!--/fact--> checks with measured error against a
...
of <!--fact:uiStrings-->3612<!--/fact--> strings, and
...
```bash
npm test                  # <!--fact:jestTests-->5324<!--/fact--> tests across <!--fact:jestSuites-->150<!--/fact--> suites
...
| JavaScript at start-up | <!--fact:buildStartupJs-->614<!--/fact--> KB           | <!--fact:buildStartupFiles-->50<!--/fact-->   |
| JavaScript on demand   | <!--fact:buildDeferredJs-->3875<!--/fact--> KB         | <!--fact:buildDeferredChunks-->137<!--/fact--> |
| **Initial download**   | **<!--fact:buildInitialDownload-->813<!--/fact--> KB** |                                               |
...
The suite is <!--fact:e2eTests-->1184<!--/fact--> tests
...
That is <!--fact:physicsChecks-->248<!--/fact--> deterministic checks, about
...
result depends on what the software did — which, for anything reproducible, is
always. It names one release and will never point anywhere else. The **concept
DOI** resolves to whichever release is newest, which is what the badge above
uses and what belongs in a "cite the software" link; it is the wrong thing to
