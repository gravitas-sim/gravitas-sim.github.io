...
of <!--fact:uiStrings-->4085<!--/fact--> strings, and
...
```bash
npm test                  # <!--fact:jestTests-->5791<!--/fact--> tests across <!--fact:jestSuites-->169<!--/fact--> suites
...
| JavaScript on demand   | <!--fact:buildDeferredJs-->4077<!--/fact--> KB         | <!--fact:buildDeferredChunks-->151<!--/fact--> |
...
The suite is <!--fact:e2eTests-->1215<!--/fact--> tests
