...
//
// This reads headers, and the scalar binary-table columns of the types a
// light curve uses: L, B, I, J, K, E, D. Anything else in a file it is asked
// to read - an image, a tile-compressed table, a variable-length array, an
// ASCII table, a column with a repeat count - is listed in `unread` rather than
// guessed at, and a column the caller asks for by name that is not readable is
// an error. The observation data-pack gate measured it at 1.5 KB and 11 ms on a
 ...
 * @returns {Array<{cards: object, columns?: object, unread?: object[]}>}
 */
