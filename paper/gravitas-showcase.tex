...
\newcommand{\CodeSnapshot}{a4e6ab3a5ecb69290742c7197ed545737136182a}
...
\author[0000-0000-0000-0000]{Carl Ziegler}
...
\begin{deluxetable*}{p{0.17\textwidth}p{0.31\textwidth}p{0.45\textwidth}}
\tablecaption{Guided investigation catalogue\label{tab:investigations}}
\tablehead{\colhead{Theme} & \colhead{Investigations} &
\colhead{Representative student work}}
\startdata
Orbits and gravity &
...
\enddata
\tablecomments{Durations and prerequisites are supplied in the application. The
catalogue can be filtered by concept, and individual investigations may be
assigned through reproducible links.}
\end{deluxetable*}
...
\begin{deluxetable*}{p{0.21\textwidth}p{0.34\textwidth}p{0.38\textwidth}}
\tablecaption{Student tools and the reasoning they support\label{tab:tools}}
\tablehead{\colhead{Tool} & \colhead{What the student records} &
\colhead{Example question}}
\startdata
